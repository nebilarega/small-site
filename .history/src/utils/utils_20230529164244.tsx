...
export function createBoundingBoxHelper(
  ...
  if (type) {
    ...
    const planeGeometry = new THREE.PlaneGeometry(0.5, 0.15);
    ...
    twelvePosition.addVectors(
      box.min,
      new THREE.Vector3(box.min.x, box.min.y, box.max.z).multiplyScalar(0.5)
    ); // Vertex 0
    ...
    twelvePlane.lookAt(new THREE.Vector3(0, twelvePlane.position.y, 0));
