...
export function createBoundingBoxHelper(
  ...
  const anotherGeometry = new LineGeometry();
  ...
  for (let i = 0; i < edge2.length; i++) {
    ...
    verticesArray2[i * 6 + 0] = vertex1.x;
    verticesArray2[i * 6 + 1] = vertex1.y;
    verticesArray2[i * 6 + 2] = vertex1.z;
    verticesArray2[i * 6 + 3] = vertex2.x;
    verticesArray2[i * 6 + 4] = vertex2.y;
    verticesArray2[i * 6 + 5] = vertex2.z;
  }

  newGeometry.setPositions(verticesArray);
  anotherGeometry.setPositions(verticesArray2);
  ...
  const line1 = new Line2(newGeometry, matLine);
  const line2 = new Line2(anotherGeometry, matLine);
  line2.name = "boundingBox";
  line1.name = "boundingBox2";
